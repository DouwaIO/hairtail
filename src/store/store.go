...
type Store interface {
    ...
    GetWorkflows(string) ([]*model.Workflow, error)
    GetWorkflow(string) (*model.Workflow, error)
    CreateWorkflow(*model.Workflow) error
    UpdateWorkflow(*model.Workflow) error
    DeleteWorkflow(string) error
}
