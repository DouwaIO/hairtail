...
import (
	...
	"gitlab.com/douwa/registry/dougo/src/dougo/shared/token"
...
func GetRole(c *gin.Context, grpc_client pb.GreeterClient) (string, error) {
	...
	r, err := grpc_client.GetRole(context.Background(), &pb.ProjectRequest{Token: token, Projectname: project.Name})
	if err != nil {
